    ...
    public void validacionDatosRegistrados(View view) {
        ...
        db.collection("usuarios").document()
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(RegistroPropietario.this, "No fue posible crear el usuario", Toast.LENGTH_LONG).show();
                });

        Intent intent = new Intent(RegistroPropietario.this, MainActivity.class);
        intent.putExtra("origen", "usuarioPropietarioCreado");
